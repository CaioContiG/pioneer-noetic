...
struct SonarArray_
{
  ...
  _ranges_count_type ranges_count;
   ...
   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _ranges_type;
  _ranges_type ranges;
...
bool operator==(const ::p2os_msgs::SonarArray_<ContainerAllocator1> & lhs, const ::p2os_msgs::SonarArray_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.ranges_count == rhs.ranges_count &&

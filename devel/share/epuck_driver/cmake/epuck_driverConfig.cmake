...
if("TRUE" STREQUAL "TRUE")
  set(epuck_driver_SOURCE_PREFIX /home/caio/kioneer_ws/src/epuck_driver)
  set(epuck_driver_DEVEL_PREFIX /home/caio/kioneer_ws/devel)
  ...
  set(epuck_driver_INSTALL_PREFIX /home/caio/kioneer_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'epuck_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/caio/kioneer_ws/src/epuck_driver/${idir}'.  ${_report}")
    endif()
